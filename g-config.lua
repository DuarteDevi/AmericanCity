...
system = {
    ...
    ['webhook'] = {
        ...
        ['addVip'] = {['use'] = true, ['link'] = "https://canary.discord.com/api/webhooks/1040787427939319858/Tf2rIbMWwKuu14FIvrz9ZuAYEOY8k1KEzjlbvtSUA382xnw3NHAx9i-5n76AoIWFkAdz"}, -- Opção caso queira ou não utilizar o sistema, link da webhook do canal do Discord para logs.
